...
#+BEGIN_SRC emacs-lisp
(set-register ?e (cons 'file (concat user-emacs-directory "maiku.org")))
...
(use-package helm-config
  ...
  :config
  (setq helm-adaptive-history-file (concat user-emacs-directory "helm-adaptive-history"))
...
(use-package yasnippet
  ...
  :mode (("/my-snippets/" . snippet-mode)
         ("/yasnippets-snippets/" . snippet-mode))
  :init
